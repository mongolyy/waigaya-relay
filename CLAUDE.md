...
After addressing a review comment, do NOT resolve the conversation. Instead, mention the reviewer (e.g., `@username`) in your reply so they are notified. The reviewer decides the next step:
